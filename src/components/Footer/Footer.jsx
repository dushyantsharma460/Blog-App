      ...
      <div className='max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8'>
        <div>
          <div className="flex items-center mb-4">
            ...
            <span className="text-lg font-bold text-gray-800">Dushyant Blog</span>
          </div>
          <p className='text-sm text-gray-600'>
            Simple, clean blogging platform.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className='space-y-2 text-sm'>
            ...
            <li><Link to='/posts' className='text-gray-600 hover:text-blue-600'>All Posts</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <p className="text-xs text-gray-500 mt-4">
            &copy; {new Date().getFullYear()} Dushyant Blog. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
